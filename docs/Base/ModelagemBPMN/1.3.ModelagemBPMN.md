# Modelagem BPMN do Projeto QueroBemEstar
...
O seguinte diagrama representa o fluxo de um usuário em nosso produto. Ele é ainda um esquema inicial e pode sobre alterações ao decorrer das sprints
